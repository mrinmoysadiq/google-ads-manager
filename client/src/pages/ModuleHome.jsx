    ...
    <div className="min-h-[calc(100vh-64px)] bg-[#1b1b1b] flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full max-w-5xl">
        ...
        <ModuleCard
          ...
          title="Outreach CRM"
          description="Track prospects through your outreach pipeline — manage touchpoints, monitor follow-ups, and measure conversion from first contact to closed client."
